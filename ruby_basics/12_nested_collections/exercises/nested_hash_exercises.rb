...
def find_beautiful_languages(languages)
  ...
  beautiful_languages = {}
  languages.each do |language_name, language_info_value|
    if language_info_value[:is_beautiful?] == true
      beautiful_languages[language_name] = language_info_value
    end
  end
...
def find_language_facts(languages, language_name, fact_index = 0)
  ...
  #                 is_beautiful?: false }
  # }
  facts_arr = languages.dig(language_name, :facts)
  if facts_arr != nil
    facts_arr[fact_index]
  else
    nil
  end
end
